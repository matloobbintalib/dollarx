...
import 'package:dollarax/modules/intractive_chart/chart_painter.dart';
import 'package:dollarax/modules/intractive_chart/chart_style.dart';
import 'package:dollarax/modules/intractive_chart/models/candle_data.dart';
import 'package:dollarax/modules/intractive_chart/painter_params.dart';
...
class InteractiveChart extends StatefulWidget {
  ...
  const InteractiveChart({
    ...
    this.onCandleResize,
        ...
        assert(initialVisibleCandleCount > 0,
...
class _InteractiveChartState extends State<InteractiveChart> {
  ...
  Map<String, String> defaultOverlayInfo(CandleData candle) {
    ...
    if(candle.timestamp!= null){
       DateTime dateTime = DateTime.fromMillisecondsSinceEpoch(candle.timestamp!);
       date = DateFormat('yyyy-MM-dd').format(dateTime);
    }
    return {
      "Date": date,
