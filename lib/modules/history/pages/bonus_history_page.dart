import 'package:dollarax/modules/history/cubit/bonus/bonus_history_cubit.dart';
import 'package:dollarax/modules/history/widget/bonus_history_widget.dart';
              ...
              return RefreshIndicator(
                onRefresh: (){
                  return Future.delayed(
                    Duration(seconds: 1),
                        () {
                      context.read<BonusHistoryCubit>()
                        ..bonusHistory();
                    },
                  );
                },
