...
class InvestmentWidget extends StatelessWidget {
  ...
  const InvestmentWidget({super.key, required this.iconPath, required this.title, required this.price,required this.onTap});
          ...
          children: [
            ...
            Expanded(
              child: Container(
                ...
                child: Text(price,
                  style: context.textTheme.bodyLarge?.copyWith(fontSize: 16),textAlign: TextAlign.center,),
              ),
            )
          ],
        ),
