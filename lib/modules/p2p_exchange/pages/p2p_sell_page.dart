...
class P2PSellPage extends StatefulWidget {
  ...
  const P2PSellPage({super.key, required this.exchangeModel});
                        ...
                        if(showPaymentInfo)...[
                                ...
                                Row(
                                  children: [
                                    ...
                                    IconButton(
                                        ...
                                        onPressed: () {
                                          copyText(widget.exchangeModel.buyAmount);
                                        },
                                        icon: Image.asset(
                                ...
                                Row(
                                  children: [
                                    ...
                                    IconButton(
                                        ...
                                        padding: EdgeInsets.all(10),
                                        onPressed: () {
                                          copyText(widget.exchangeModel.accountName);
                                        },
                                        icon: Image.asset(
                                          "assets/images/png/icon_copy.png",
                                          height: 16,
                                ...
                                Row(
                                  children: [
                                    ...
                                    IconButton(
                                        ...
                                        padding: EdgeInsets.all(10),
                                        onPressed: () {
                                          copyText(widget.exchangeModel.accountNo);
                                        },
                                        icon: Image.asset(
                                          "assets/images/png/icon_copy.png",
                                          height: 16,
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(
                                horizontal: 12, vertical: 8),
                            child: Text(
                              'Insure the payment is successful,then received Payment Screenshot to buyer.',
                              style: context.textTheme.bodyMedium
                                  ?.copyWith(fontWeight: FontWeight.w400),
                            ),
                          ),
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(
                                horizontal: 12, vertical: 8),
                            child: Text(
                              imagePickerState.hasImage ? imagePickerState.file!.path:'',
                              style: context.textTheme.bodyMedium
                                  ?.copyWith(fontWeight: FontWeight.w400),
                            ),
                          ),
